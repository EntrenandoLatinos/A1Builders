...
from app_core.forms import ContactForm, BannerForm, AboutForm, SkillForm, CounterForm, ServiceForm, ServiceDeleteForm, \
    SubServiceForm, TestimonialForm, TestimonialDeleteForm, PartnerForm, FaqForm, PrivacyForm, WorkForm, SocialMediaForm
...
def google_business_update(request, pk):
    ...
    context = {'testimonial': testimonial, 'testimonial_form': testimonial_form,
